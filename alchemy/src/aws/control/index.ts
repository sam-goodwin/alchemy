import { createResourceType } from "./resource";
 ...
 */
const GenericCloudControlResource = new Proxy(
  {},
  {
...
// Export the proxy with proper typing from the generated types
export default GenericCloudControlResource as typeof import("./types");
