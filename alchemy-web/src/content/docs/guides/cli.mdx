...
<TabItem label="Deploy to Production">
```sh
bun ./alchemy.run --stage production
```
</TabItem>
<TabItem label="Read-only Check">
```sh
bun ./alchemy.run --read
```
</TabItem>
<TabItem label="Quiet Deploy">
```sh
bun ./alchemy.run --quiet
```
</TabItem>
<TabItem label="Destroy Everything">
```sh
bun ./alchemy.run --destroy
```
</TabItem>
<TabItem label="Deploy with Secrets">
```sh
ALCHEMY_PASSWORD=my-secret-key bun ./alchemy.run
```
</TabItem>
